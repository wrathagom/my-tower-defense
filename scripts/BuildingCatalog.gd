...
func build_defs(config: GameConfig) -> Dictionary:
	return {
		"grunt_tower": {
			...
			"size": 1,
			"placement": "grid",
			"costs": {"wood": config.tower_cost},
			"build_time": config.build_time_tower,
		...
		"woodcutter": {
			...
			"size": 2,
			"placement": "tree",
			"costs": {"wood": config.woodcutter_cost},
			"build_time": config.build_time_woodcutter,
			"requirements": [{"type": "base_level", "value": 1}],
			"resource_kind": "wood",
		},
		"stonecutter": {
			...
			"size": 2,
			"placement": "stone",
			"costs": {"wood": config.stonecutter_cost},
			"build_time": config.build_time_stonecutter,
		...
		"iron_miner": {
			...
			"size": 2,
			"placement": "iron",
			"costs": {"wood": config.iron_miner_cost},
			"build_time": config.build_time_iron_miner,
		...
		"archery_range": {
			...
			"size": 3,
			"placement": "grid",
			"costs": {"wood": config.archery_range_cost},
			"build_time": config.build_time_archery_range,
			"requirements": [{"type": "base_level", "value": 2}],
		...
		"barracks": {
			...
			"size": 3,
			"placement": "grid",
			"costs": {"wood": config.barracks_wood_cost, "stone": config.barracks_stone_cost},
			"build_time": config.build_time_barracks,
			"requirements": [{"type": "base_level", "value": 3}],
			"effect": "barracks",
		},
		"house": {
			...
			"size": 2,
			"placement": "grid",
			"costs": {"wood": config.house_cost},
			"build_time": config.build_time_house,
			"requirements": [{"type": "base_level", "value": 1}],
			"effect": "house",
		},
		"farm": {
			...
			"size": 2,
			"placement": "grid",
			"costs": {"wood": config.farm_cost},
			"build_time": config.build_time_farm,
			"requirements": [{"type": "base_level", "value": 1}],
			"effect": "farm",
		},
		"wood_storage": {
			...
			"size": 2,
			"placement": "grid",
			"costs": {"wood": config.wood_storage_cost},
			"build_time": config.build_time_wood_storage,
			"requirements": [{"type": "base_level", "value": 1}],
			"effect": "wood_storage",
		},
		"food_storage": {
			...
			"size": 2,
			"placement": "grid",
			"costs": {"wood": config.food_storage_cost},
			"build_time": config.build_time_food_storage,
			"requirements": [{"type": "base_level", "value": 1}],
			"effect": "food_storage",
		},
		"stone_storage": {
			...
			"size": 2,
			"placement": "grid",
			"costs": {"wood": config.stone_storage_cost},
			"build_time": config.build_time_stone_storage,
			"requirements": [{"type": "base_level", "value": 2}],
		...
		"iron_storage": {
			...
			"size": 2,
			"placement": "grid",
			"costs": {"wood": config.iron_storage_cost},
			"build_time": config.build_time_iron_storage,
			"requirements": [{"type": "base_level", "value": 3}],
			"effect": "iron_storage",
		},
	}
