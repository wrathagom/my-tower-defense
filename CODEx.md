...
- This project treats GDScript warnings as errors; always add explicit types for
  variables initialized from Variant-returning calls (e.g., `get(...)`) or mixed
  expressions to avoid "Cannot infer the type" parse errors.
